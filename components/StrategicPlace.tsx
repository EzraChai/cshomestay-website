      ...
      <div className="md:grid md:grid-cols-4 lg:grid-cols-5 lg:mb-40">
        <div className=" md:ml-12 lg:ml-0 lg:w-[90%] content-left relative col-span-2 lg:col-span-3 flex items-center justify-center ">
          <div className="text-center">
            <h2 className="text-lg lg:text-4xl font-semibold text-gray-600 ">
              The
              <span className="text-cyan-500 text-2xl lg:tracking-tight font-extrabold lg:text-6xl mx-1 lg:mx-4">
                strategic
              </span>
        ...
        <div className="col-span-2 mt-14 lg:mt-0 overflow-hidden">
          <div className="content-right flex justify-center">
            <iframe
              className=" aspect-square overflow-hidden rounded-lg lg:w-full"

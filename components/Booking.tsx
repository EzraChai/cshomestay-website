      ...
      <div className="book-now-card py-36 text-primary max-w-[100rem] mx-auto">
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 max-w-[80%] lg:max-w-[60%] mx-auto gap-10 pb-8">
            ...
            >
              <div className="absolute bottom-4 right-4 border-2 border-zinc-800 text-zinc-800 tracking-wider select-none uppercase font-bold text-xs flex justify-center items-center rounded-xl px-2 py-[0.125rem]">LOWEST PRICE</div>
